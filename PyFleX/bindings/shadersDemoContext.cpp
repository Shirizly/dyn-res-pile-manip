...
void DrawPlane(const Vec4& p, bool color, float scale_size) { s_context->drawPlane(p, color, scale_size); }

void DrawPlanes(Vec4* planes, int n, float bias, float scale_size) { s_context->drawPlanes(planes, n, bias, scale_size); }
